                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            ...
                                            <button type="button" class="btn btn-success" onclick="agregarSucursal()">Registrar Sucursal</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
          ...
          $.ajax({
            ...
            success:function(data){
                ...
                if(datos.resp == "true"){
                    new PNotify({
                        title: 'CORRECTO',
                        text: 'Nueva Sucursal ('+nombre+') fue Registrado correctamente.',
                        type: 'success',
                        styling: 'bootstrap3'
                    });
                    verificarAcceso("Permiso_Sucursal");
                ...
                if(datos.resp == "false"){
                    new PNotify({
                        title: 'ERROR',
                        text: 'Hubo un fallo al registrar La Sucursal. Verifique que ningun dato sea registrado y Vuelva a Intentarlo.',
                        styling: 'bootstrap3'
                    });
                }
                if(datos.resp != "true" && datos.resp != "false"){
                    new PNotify({
                        title: 'ERROR',
                        text: "Hubo un fallo al registrar la Sucursal CODIGO DE ERROR:"+datos.resp+". Contactese con el Administrador.",
                        type: 'error',
                        styling: 'bootstrap3'
                    });
                }
