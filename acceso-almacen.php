  ...
  <body class="nav-md">
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Agregar Acceso<small>A Almacen</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Acceso a Almacen</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" id="cboxAlmacen">
    ...
    <script>
        function listaSucursal(){
            ...
            var cboxSucursal = document.getElementById("cboxAlmacen");
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(datos.resp == "true"){
                        new PNotify({
                            title: 'CORRECTO',
                            text: 'Se permitio el Acceso del Almacen al usuario correctamente.',
                            type: 'success',
                            styling: 'bootstrap3'
                        });
                        verificarAcceso("Permiso_Acceso");
