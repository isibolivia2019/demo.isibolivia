        ...
        <div class="right_col" role="main">
            ...
            <div class="page-title">
              <div class="title_left">
                <h3>Usuarios <small> Habilitados</small></h3>
              </div>
            </div>
                      ...
                      success:function(data){
                          ...
                          if(datos.resp == "true"){
                            new PNotify({
                              ...
                              text: 'El Usuario '+usuario+' fue deshabilitado al Acceso del sistema correctamente.',
                              type: 'success',
                              styling: 'bootstrap3'
                            });
                            verificarAcceso("Permiso_Usuario");
                          ...
                          if(datos.resp == "false"){
                              new PNotify({
                                ...
                                text: 'Hubo un fallo al deshabilitar al usuario'+usuario+' del Sistema. Recargue la pagina y vuelva a Intentarlo.',
                                styling: 'bootstrap3'
                              });
                          }
        ...
        function actualizarLista(){
            ...
            table = $('#table-simple').DataTable({
                ...
                "columns": [
                    ...
                    {"defaultContent" : "<button id='deshabilitar' class='deshabilitar btn btn-danger' type='submit' name='action'><i class='glyphicon glyphicon-ban-circle'></i></button>"}
                ],
                "language": {
