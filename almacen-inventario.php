                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h5 class="brief"><i>Datos del Almacen</i></h5>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
              ...
              success:function(data){
                ...
                document.getElementById("lblNombre").innerHTML = datos[0].nombre_almacen
                document.getElementById("lblDireccion").innerHTML = "<strong>Direccion: </strong>"+datos[0].direccion_almacen
                document.getElementById("lblTelefono").innerHTML = "<strong>Telefono: </strong>"+datos[0].telefono_almacen
              }
            })
        });
