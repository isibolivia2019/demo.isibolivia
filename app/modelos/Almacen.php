...
class Almacen{
	...
	public function agregarAlmacen($datos){
		$sql = "INSERT INTO almacen(cod_almacen, nombre_almacen, direccion_almacen, telefono_almacen) VALUES(?,?,?,?);";
	...
	public function actualizarAlmacen($datos){
		$sql = "UPDATE almacen SET nombre_almacen = ?, direccion_almacen = ?, telefono_almacen = ? WHERE cod_almacen = ? ";
