...
class Producto{
  ...
  public function listaProductos($datos){
	...
	public function agregarProducto($datos){
		$sql = "INSERT INTO producto(cod_producto, nombre_producto, descripcion_producto, color_producto, imagen_producto, estado_producto) VALUES(?,?,?,?,?,?);";
		return $this->db->insert($sql, $datos);
	}

	public function actualizarProducto($datos){
		$sql = "UPDATE producto SET nombre_producto = ?, descripcion_producto = ?, color_producto = ? WHERE cod_producto = ? ";
