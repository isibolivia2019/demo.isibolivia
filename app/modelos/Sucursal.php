...
class Sucursal{
	...
	public function agregarSucursal($datos){
		$sql = "INSERT INTO sucursal(cod_sucursal, nombre_sucursal, direccion_sucursal, telefono_sucursal, imagen_sucursal) VALUES(?,?,?,?,?);";
	...
	public function actualizarSucursal($datos){
		$sql = "UPDATE sucursal SET nombre_sucursal = ?, direccion_sucursal = ?, telefono_sucursal = ? WHERE cod_sucursal = ? ";
