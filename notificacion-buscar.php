        ...
        <div class="right_col" role="main">
            ...
            <div class="page-title">
              <div class="title_left">
                <h3>Buscar <small> Notificaciones del Sistema</small></h3>
              </div>
            </div>
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                  <button type="button" class="btn btn-success" onclick="listaNotificacion()">Buscar Registros de Notificacion</button>
                              </div>
                          </div>
                      </form>
                  </div>
        ...
        function listaNotificacion(){
            ...
            var cboxMes = document.getElementById("cboxMes").value;
              ...
              if(cboxAño != ""){
                if(cboxMes != ""){
                  var parametros = {
                "action" : "buscarNotificacionFecha",
                "año" : cboxAño,
                "mes" : cboxMes
            };
